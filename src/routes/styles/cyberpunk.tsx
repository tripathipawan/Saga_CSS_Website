  ...
  head: () => ({
    meta: [
      { title: "Cyberpunk / Neon UI Generator — SagaCSS" },
      {
        name: "description",
        content:
          "Design neon-glow cards, buttons and scanline backgrounds with the SagaCSS cyberpunk UI generator.",
      },
...
letter-spacing: .08em;`;
  ...
  return (
    <div className="flex flex-col gap-6">
      <ToolHeader
        title="Cyberpunk / Neon UI"
        description="Layered neon glow, scanlines and cyber-grid textures for dark UI vibes."
      />

      <div
        className="flex min-h-[18rem] items-center justify-center rounded-2xl border border-border p-8"
        style={{ background: bg }}
      >
        <div
          style={{
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="flex flex-col gap-4 rounded-xl border border-border bg-card p-4 md:p-5">
          ...
          <div>
            <Label htmlFor="cp-text" className="text-xs">
              Text
            </Label>
            <Input
              id="cp-text"
