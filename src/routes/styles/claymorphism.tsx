  ...
  head: () => ({
    meta: [
      { title: "Claymorphism Generator — SagaCSS" },
      {
        name: "description",
        content:
          "Design puffy, pastel clay-style UI with combined inner and outer shadows and copy-ready CSS.",
      },
  ...
  return (
    <div className="flex flex-col gap-6">
      <ToolHeader
        ...
        description="Design puffy, pastel clay-like elements with combined inner and outer shadows."
      />
      ...
      <div className="flex min-h-[16rem] max-h-[18rem] items-center justify-center rounded-2xl border border-border bg-slate-50 p-10 dark:bg-slate-900">
        <div
          className="h-40 w-56 md:h-48 md:w-72"
          style={{
            background: bg,
            borderRadius: radius,
            boxShadow: shadow,
          ...
          aria-label="Claymorphism preview"
          role="img"
        />
      </div>
        ...
        <div className="rounded-xl border border-border bg-card p-4 md:p-5">
          ...
          <div className="mb-3 grid grid-cols-[auto_1fr] items-center gap-3">
            ...
            <div className="text-xs text-muted-foreground">
              Pastel background — softer hues work best
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {(
              [
                ...
                { label: "Puff intensity", val: intensity, set: setIntensity, min: 5, max: 60 },
              ] as const
            ).map((c) => (
              <div key={c.label}>
